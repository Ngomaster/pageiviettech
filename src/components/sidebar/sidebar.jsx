								...
								<div className="row">
									<div className="col-12 col-md-6">
										...
										<h2 className="text-zinc-100">
											MỪNG SINH NHẬT THÁNG 3 - IVIETTECH GIẢM GIÁ HỌC
											PHÍ THẢ GA
										</h2>
										<p className="text-zinc-100">
											Mừng sinh nhật năm thứ 9, trung tâm iViettech
											sẽ giảm trực tiếp % học phí trọn gói và tặng
											quà (mũ bảo hiểm hoặc áo iViettech) cho các
											bạn…
										</p>
									</div>
									<div className="col-12 col-md-6">
										<div className="flex">
											...
											<div>
												<p className="text-zinc-100">
													LỘC LÁ ĐẦU THÁNG HAI - AI SẼ LÀ NGƯỜI MAY
													MẮN NHẤT?
												</p>
											</div>
										</div>
										<div className="flex">
											...
											<div>
												<p className="text-zinc-100">
													GIẢM 10% HỌC PHÍ TRỌN GÓI TOÀN BỘ KHÓA
													HỌC - ƯU ĐÃI CÓ HẠN
												</p>
											</div>
										</div>
										...
										<div className="flex">
											...
											<div>
												<p className="text-zinc-100">
													LỘC XUÂN - KHUÂN SỚM 2023 - GIẢM NGAY 10%
													HỌC PHÍ
												</p>
											</div>
										</div>
